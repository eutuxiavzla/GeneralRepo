...
<style type="text/css">
	...
	<section class="my-3" id="container">
		<div class="banner_container">
			...
			<form action="{{route('banners.update', $banner->id)}}" class="inputs" id="form"  method="POST" enctype="multipart/form-data">
				@csrf
				<div class="d-flex">
				...
				<div class="inputs_body">
					<input class="form-control mb-5" style="width: 50%;" id="i_title" type="text" class="mb-5" name="title" placeholder="Titulo" value="{{$banner->title}}">
					<textarea class="form-control" name="description" style="width: 50%;" id="i_description" placeholder="Descripción">{{$banner->description}}</textarea>
				</div>
			</form>
		</div>

		<div class="d-flex justify-content-center my-3 ">
			<button type="button" id="button_submit" class="btn btn-success mr-5">Actualizar</button>
			<a href="{{route('banners.home')}}" class="btn btn-outline-success">cancelar</a>
		</div>
	</section>
