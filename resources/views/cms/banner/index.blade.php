...
@section('content')
    ...
    <section>
        <div class="my-3 d-flex justify-content-between">
            <h3>Imagenes del banner principal</h3>
            <div>
                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                <a href="{{ route('banners.show', $banner->id) }}"
                                    class="btn btn-outline-success mr-1 btn-sm">Editar</a>
                                @if ($banner->status == 1)
                                    <a href="{{ route('banners.desactive', $banner->id) }}"
                                        class="btn btn-outline-success mr-1 btn-sm">Ocultar</a>
                                @elseif($banner->status == 0)
                                    <a href="{{ route('banners.active', $banner->id) }}"
                                        class="btn btn-outline-info mr-1 btn-sm">Mostrar</a>
                                @endif
                                <button type="button" id="{{ $banner->id }}" class="btn btn-outline-danger eliminar btn-sm"
